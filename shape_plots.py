...
if __name__ == "__main__":
    ...
    if len(sys.argv) == 5:
        ...
        print "Run using:"
        print "python shape_plots.py <Inc/Exc> # for all variable, njet, btag bins and whether Inclusive or Exclusive"
        print "python shape_plots.py <variable> <njet> <btag> <Inc/Exc> # for one specific case"
        exit(1)
